...
export const EditorData = () => (
  <div>
    <h3>
      Front-end development refers to the part of web development that focuses
      on creating and designing the user interface and experience of a website
      or web application. It involves using languages such as HTML, CSS, and
      JavaScript to build the visual and interactive elements that users
      interact with directly in their web browsers. HTML (HyperText Markup
      Language) is the backbone of any web page. It provides the structure and
      content of a webpage by using a markup language of tags and elements that
      define headings, paragraphs, images, links, and other elements. CSS
      (Cascading Style Sheets) is used to style the HTML elements, controlling
      their layout, colors, fonts, and overall appearance. CSS allows developers
      to create visually appealing and consistent designs across different
      devices and screen sizes. JavaScript is a powerful programming language
      that adds interactivity to web pages. It allows developers to manipulate
      the HTML and CSS of a webpage dynamically, enabling features such as
      animations, form validations, interactive maps, and much more. JavaScript
      frameworks and libraries like Angular, and Vue.js have further extended
      its capabilities, making it easier to build complex web applications
      efficiently. In addition to these core technologies, front-end developers
      often work with tools like preprocessors (e.g., Sass, Less) to enhance
      their CSS workflow, task runners/build tools (e.g., Webpack, Gulp) for
      automating repetitive tasks, and version control systems (e.g., Git) for
      managing code changes collaboratively. Front-end development is crucial as
      it directly impacts how users perceive and interact with a website or
      application. A well-designed front end not only enhances egpbility and
      accessibility but also plays a significant role in the overall success of
      digital products by providing a seamless and engaging user experience. As
      web technologies continue to evolve, front-end developers must stay
      updated with new trends, best practices, and emerging tools to create
      modern and responsive interfaces that meet the needs of users and
      businesses alike.{" "}
    </h3>
  </div>
);
...
export const chatData = [
  {
    image: avatar2,
    message: "yasser Joined the Team!",
...
export const customersData = [
  {
    ...
    CustomerEmail: "ahmed.mahmoud@example.com",
    CustomerImage: avatar2,
    ProjectName: "Nile River Cruise Booking",
    Status: "Active",
    StatusBg: "#8BE78B",
    Weeks: "28",
    Budget: "$2.4k",
  ...
  },
  {
    ...
    ProjectName: "Pyramids Tourism Website",
    Status: "Active",
  ...
  },
  {
    ...
    CustomerEmail: "fatma.hassan@example.com",
    ProjectName: "Luxor Historical Guide App",
    Status: "Pending",
  ...
  },
  {
    ...
    CustomerEmail: "omar.gamal@example.com",
    ProjectName: "Aswan Adventure Tours",
    Status: "Completed",
  ...
  },
  {
    ...
    ProjectName: "Hurghada Beach Resorts",
    Status: "Cancel",
    CustomerImage: avatar2,
    StatusBg: "red",
    Weeks: "25",
  ...
  },
  {
    ...
    CustomerEmail: "youssef.khalil@example.com",
    CustomerImage: avatar2,
    ProjectName: "Alexandria Cultural Tours",
    Status: "Active",
    StatusBg: "#8BE78B",
    Weeks: "32",
    Budget: "$2.8k",
  ...
  },
  {
    ...
    ProjectName: "Sharm El Sheikh Resorts",
    Status: "Active",
    CustomerImage: avatar3,
    StatusBg: "#8BE78B",
    Weeks: "18",
  ...
  {
    CustomerID: 1023,
    CustomerName: "Noura Mansour",
    CustomerEmail: "noura.mansour@example.com",
    ProjectName: "Cairo City Guide App",
    Status: "Pending",
    CustomerImage: avatar4,
    StatusBg: "#FEC90F",
    Weeks: "24",
  ...
  {
    CustomerID: 1024,
    CustomerName: "Mahmoud Salah",
    CustomerEmail: "mahmoud.salah@example.com",
    ProjectName: "Dahab Diving Adventure",
    Status: "Completed",
    CustomerImage: avatar,
    StatusBg: "#8BE78B",
    Weeks: "40",
  ...
  },
  {
    ...
    CustomerEmail: "amira.hassan@example.com",
    ProjectName: "Luxor Historical Tours",
    Status: "Cancel",
    CustomerImage: avatar2,
    StatusBg: "red",
    Weeks: "27",
  ...
  },
  {
    ...
    CustomerEmail: "khaled.mahmoud@example.com",
    ProjectName: "Hurghada Beach Resorts",
    Status: "Active",
    CustomerImage: avatar3,
    StatusBg: "#8BE78B",
  ...
  },
  {
    ...
    ProjectName: "Giza Pyramids Tours",
    Status: "Pending",
    CustomerImage: avatar4,
    StatusBg: "#FEC90F",
    Weeks: "28",
  ...
  },
  {
    ...
    ProjectName: "Luxor Hot Air Balloon",
    Status: "Completed",
    CustomerImage: avatar,
    StatusBg: "#8BE78B",
    Weeks: "42",
  ...
  {
    CustomerID: 1035,
    CustomerName: "Aya Mohamed",
    CustomerEmail: "aya.mohamed@example.com",
    ProjectName: "Cairo Museum Guide",
    Status: "Cancel",
    CustomerImage: avatar2,
    StatusBg: "red",
    Weeks: "30",
...
export const employeesData = [
  ...
  {
    EmployeeID: 6,
    Name: "Ankhesenamun Aahotep",
    Title: "Sales Associate",
    HireDate: "02/05/2017",
    Country: "Egypt",
    ReportsTo: "Amunet Aten",
  ...
  },
  {
    ...
    HireDate: "22/03/2021",
    Country: "Egypt",
    ReportsTo: "Cleopatra Cleo",
    EmployeeImage: avatar2,
  },
  {
    EmployeeID: 21,
    Name: "Ptahhotep Ptahh",
    Title: "Software Engineer",
    HireDate: "05/06/2012",
    Country: "Egypt",
    ReportsTo: "Thutmose Thoth",
    EmployeeImage: avatar2,
  },
  {
    EmployeeID: 22,
...
export const scheduleData = [
  ...
  },
  {
    ...
    Location: "Research Center of egp",
